-- SIMPLE DATABASE SETUP - Run this entire script
-- This will create everything without ON CONFLICT issues
...
-- ===========================================
-- STEP 4: SET UP TEST DATA (SIMPLE INSERTS)
-- ===========================================

-- Get user IDs first
SELECT 'Teacher User ID:' as info, id as user_id, email FROM auth.users WHERE email = 'pratiksindhiya3@gmail.com';
SELECT 'Student User ID:' as info, id as user_id, email FROM auth.users WHERE email = 'pratiksindhiya103@gmail.com';

-- Insert teacher role and profile
...
-- Insert student role and profile
INSERT INTO user_roles (user_id, role) 
